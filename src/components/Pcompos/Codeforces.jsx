...
const codeforces = () => {
  ...
  const allContests = useSelector((store) => store.upcomingContests);
  const allPastContests = useSelector((store) => store.pastContests);
  const allBookmarkedContests = useSelector((store) => store.bookmarked);
  const coolStyle =
  ...
  const contests = allContests.filter(
    (contest) => contest.resource === "codeforces.com"
  );

  const prevContests = allPastContests.filter(
    (contest) => contest.resource === "codeforces.com"
  );

  const bookmarkedContests = allBookmarkedContests.filter(
    (contest) => contest.resource === "codeforces.com"
  );
